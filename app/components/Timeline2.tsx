          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
            ...
            >
              <span className="flex flex-col items-center text-lg md:text-xl text-center lg:text-2xl p2p">
                ...
                <p className="text-xs md:text-sm font-robotomono text-white/80">
                  29th September 2024, 10:00 am onwards
                </p>
                <Image
                  src="/platform.png"
                  width={800}
            ...
            >
              <span className="flex flex-col items-center text-lg md:text-xl text-center lg:text-2xl p2p">
                <h1>Git Basics</h1>
                <p className="text-xs md:text-sm font-robotomono text-white/80">
                  29th September 2024, 11:00 am onwards
                </p>
                <Image
                  src="/platform.png"
                  width={800}
            ...
            >
              <span className="flex flex-col items-center text-lg md:text-xl text-center lg:text-2xl p2p">
                ...
                <p className="text-xs md:text-sm font-robotomono text-white/80">
                  29th September 2024, 2:00 pm onwards
                </p>
                <Image
                  src="/platform.png"
                  width={800}
            ...
            >
              <span className="flex flex-col items-center text-lg md:text-xl text-center lg:text-2xl p2p">
                <h1>Intro to Game</h1>
                <p className="text-xs md:text-sm font-robotomono text-white/80">
                  29th September 2024, 4:30 pm onwards
                </p>
                <Image
                  src="/platform.png"
                  width={800}
            ...
            >
              <span className="flex flex-col items-center text-lg md:text-xl text-center lg:text-2xl p2p">
                ...
                <p className="text-xs md:text-sm font-robotomono text-white/80">
                  29th September 2024, 6:00 pm onwards
                </p>
                <Image
                  src="/platform.png"
                  width={800}
