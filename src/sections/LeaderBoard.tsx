...
const Leaderboard: React.FC = () => {
        ...
        <div className="flex flex-row items-start mt-3">
            ...
            <div style={{ position: 'relative' }}>
                    ...
                    {[...Array(8)].map((_, index) => (
                        <img
                            ...
                            style={{
                                width: '80px',
                                height: 'auto',
                                position: 'absolute', // Position bricks relative to parent
                                top: '-4.75rem',
                                left: '1450px', // Spacing between bricks
                                clipPath: 'inset(0 0 0 65%)', // Show only one-third of the brick image
                            }}
                        />
                    ))}
                </div>
                ...
                <div style={{ position: 'relative' }}>
                    ...
                    <img
                        ...
                        style={{
                            ...
                            marginRight: '3rem', // Keep consistent spacing
                            marginLeft: '0rem',
                            marginTop: '-1.20rem' // Space between second and third Brick
                        }}
                    />
                    {/* Third Brick (Right) */}
                    <img
                ...
                <div 
                    style={{
                        position: 'absolute', 
                        top: '24%', // Center text vertically
                        left: '19%', // Center text horizontally
            ...
            <div 
                style={{
                    position: 'relative', 
                    marginTop: '-46rem', // Adjust if needed
                    marginLeft: '43rem',
    ...
    style={{
        ...
        marginTop: '-1rem',
        marginLeft: '38rem', // Adjust margins as needed
